...
#
#	Shadow-4.17.3 - built after Linux-PAM-1.7.0
#
#    unset functions
unset -f Src_prepare
...
zconfig="--prefix=/usr --disable-static --without-libbsd --with-bcrypt --with-yescrypt"
#
#   Build Functions
#
Src_prepare() {
	sed -i 's/groups$(EXEEXT) //' src/Makefile.in && echo " Patched "
...
Src_install() {
    make exec_prefix=/usr pamddir= install || return 55
}
