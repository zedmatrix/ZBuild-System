...
pkgname=libssh2
pkgver=1.11.1
pkgurl="https://www.libssh2.org/download/libssh2-1.11.1.tar.gz"
pkgmd5='38857d10b5c5deb198d6989dacace2e6'
pkgpatch=""
zdelete="true"
pkgdir=${pkgname}-${pkgver}
zconfig="--prefix=/usr --disable-static --disable-docker-tests"
#
#   Build Functions
#
Src_configure() {
