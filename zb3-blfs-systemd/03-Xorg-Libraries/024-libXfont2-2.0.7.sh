...
pkgname=libXfont2
pkgver=2.0.7
pkgurl="https://www.x.org/pub/individual/lib/libXfont2-2.0.7.tar.xz"
pkgmd5='66e03e3405d923dfaf319d6f2b47e3da'
pkgpatch=""
zdelete="true"
pkgdir=${pkgname}-${pkgver}
#   Xorg Configure
zconfig="--prefix=/usr --sysconfdir=/etc --localstatedir=/var --disable-static"
zconfig="${zconfig} --disable-devel-docs --docdir=/usr/share/doc/$pkgdir"
#
#   Build Functions
#
Src_configure() {
