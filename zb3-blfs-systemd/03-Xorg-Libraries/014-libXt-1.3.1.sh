...
pkgname=libXt
pkgver=1.3.1
pkgurl="https://www.x.org/pub/individual/lib/libXt-1.3.1.tar.xz"
pkgmd5='9acd189c68750b5028cf120e53c68009'
pkgpatch=""
zdelete="true"
pkgdir=${pkgname}-${pkgver}
#   Xorg Configure
zconfig="--prefix=/usr --sysconfdir=/etc --localstatedir=/var --disable-static"
zconfig="${zconfig} --with-appdefaultdir=/etc/X11/app-defaults --docdir=/usr/share/doc/$pkgdir"
#
#   Build Functions
#
Src_configure() {
