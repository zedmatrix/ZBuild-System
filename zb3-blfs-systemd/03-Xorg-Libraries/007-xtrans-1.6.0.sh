...
pkgname=xtrans
pkgver=1.6.0
pkgurl="https://www.x.org/pub/individual/lib/xtrans-1.6.0.tar.xz"
pkgmd5='6ad67d4858814ac24e618b8072900664'
pkgpatch=""
zdelete="true"
pkgdir=${pkgname}-${pkgver}
#   Xorg Configure
zconfig="--prefix=/usr --sysconfdir=/etc --localstatedir=/var"
