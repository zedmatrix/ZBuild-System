...
pkgname=iso-codes
pkgver=4.17.0
pkgurl="https://salsa.debian.org/iso-codes-team/iso-codes/-/archive/v4.17.0/iso-codes-v4.17.0.tar.gz"
pkgmd5='f4b460577728ba331e078ad8bd246c98'
pkgpatch=""
zdelete="true"
#   Configure
...
Src_install() {
    make install LN_S='ln -sfn' || return 55
}
