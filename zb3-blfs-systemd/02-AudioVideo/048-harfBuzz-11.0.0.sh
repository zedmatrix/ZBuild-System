...
pkgname=harfBuzz
pkgver=11.0.0
pkgurl="https://github.com/harfbuzz/harfbuzz/releases/download/11.0.0/harfbuzz-11.0.0.tar.xz"
pkgmd5='6c05bc46689a6f2a98b784c683654fd4'
pkgpatch=""
zdelete="true"
pkgdir=${pkgname}-${pkgver}
zconfig="--prefix=/usr --buildtype=release -D graphite2=enabled"
#
#   Build Functions
#
Src_prepare() {
