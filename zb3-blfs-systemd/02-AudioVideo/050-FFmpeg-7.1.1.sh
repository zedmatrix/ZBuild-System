...
Src_check() {
	...
	install -v -m644 doc/*.txt /usr/share/doc/$pkgdir
	install -v -m755 -d /usr/share/doc/$pkgdir/api
	cp -vr doc/doxy/html/* /usr/share/doc/$pkgdir/api
	find /usr/share/doc/$pkgdir/api -type f -exec chmod -c 0644 \{} \;
	find /usr/share/doc/$pkgdir/api -type d -exec chmod -c 0755 \{} \;
}
Src_install() {
