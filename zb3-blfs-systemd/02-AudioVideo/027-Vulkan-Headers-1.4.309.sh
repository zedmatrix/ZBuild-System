...
pkgver=1.4.309
pkgurl="https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.4.309/Vulkan-Headers-1.4.309.tar.gz"
pkgmd5='dfdd9d378a077fa7a2a9180622420b8e'
pkgpatch=""
zdelete="true"
#   Configure
pkgdir=${pkgname}-${pkgver}
zconfig="CMAKE_INSTALL_PREFIX=/usr -D CMAKE_BUILD_TYPE=Release -G Ninja"
#
#   Build Functions
#
Src_prepare() {
