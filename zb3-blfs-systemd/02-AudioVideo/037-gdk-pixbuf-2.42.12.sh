...
pkgname=gdk-pixbuf
pkgver=2.42.12
pkgurl="https://download.gnome.org/sources/gdk-pixbuf/2.42/gdk-pixbuf-2.42.12.tar.xz"
pkgmd5='f986fdbba5ec6233c96f8b6535811780'
pkgpatch=""
zdelete="true"
pkgdir=${pkgname}-${pkgver}
zconfig="--prefix=/usr --buildtype=release -Dothers=enabled -Dtests=false --wrap-mode=nofallback"
#
#   Build Functions
#
Src_prepare() {
