...
pkgname=graphite2
pkgver=1.3.14
pkgurl="https://github.com/silnrsi/graphite/releases/download/1.3.14/graphite2-1.3.14.tgz"
pkgmd5='1bccb985a7da01092bfb53bb5041e836'
pkgpatch=""
zdelete="true"
...
#
Src_prepare() {
	sed -i '/cmptest/d' tests/CMakeLists.txt && echo " Patched "
    mkdir -v build
    cd build
}
Src_configure() {
